...
python -m bitschema generate tests/fixtures/valid_schema.yaml

# Test generate to file
python -m bitschema generate tests/fixtures/valid_schema.yaml --output /tmp/person.py
cat /tmp/person.py

# Test jsonschema
python -m bitschema jsonschema tests/fixtures/valid_schema.yaml

# Test visualize ascii
python -m bitschema visualize tests/fixtures/valid_schema.yaml

# Test visualize markdown
python -m bitschema visualize tests/fixtures/valid_schema.yaml --format markdown
...
bitschema generate tests/fixtures/valid_schema.yaml --output /tmp/person_cli.py
...
class TestGenerateCommand:
    def test_generate_to_stdout(self):
        # Run: python -m bitschema generate tests/fixtures/valid_schema.yaml
...
class TestJsonSchemaCommand:
    def test_jsonschema_to_stdout(self):
        # Run: python -m bitschema jsonschema tests/fixtures/valid_schema.yaml
...
class TestVisualizeCommand:
    def test_visualize_ascii_default(self):
        # Run: python -m bitschema visualize tests/fixtures/valid_schema.yaml
...
**Fixtures:**
- Use existing tests/fixtures/valid_schema.yaml for valid schema tests
...
pip install -e .
bitschema --help
bitschema generate tests/fixtures/valid_schema.yaml
bitschema jsonschema tests/fixtures/valid_schema.yaml
bitschema visualize tests/fixtures/valid_schema.yaml --format markdown
```
...
3. Test file output:
```bash
bitschema generate tests/fixtures/valid_schema.yaml --output /tmp/person.py
